...
function obtenerAreaRectangulo(alto, ancho) {
  ...
  formulaAreaRectangulo = alto * ancho;
  return formulaAreaRectangulo;
...
function retornarPerimetro(lado){
  ...
  formulaDelPerimetroCuadrado = lado*4;
  return formulaDelPerimetroCuadrado;
}
...
function areaDelTriangulo(base, altura){
  ...
  formulaAreaTriangulo = base*altura /2;
